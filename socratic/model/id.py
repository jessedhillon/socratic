...
# Organization & User
class OrganizationID(ShortUUIDKey, prefix="orgn"): ...
class UserID(ShortUUIDKey, prefix="user"): ...

# Objectives & Rubrics
class ObjectiveID(ShortUUIDKey, prefix="objv"): ...
class StrandID(ShortUUIDKey, prefix="strd"): ...
class RubricCriterionID(ShortUUIDKey, prefix="rbrc"): ...

# Assignments
class AssignmentID(ShortUUIDKey, prefix="asgn"): ...

# Assessment
class AttemptID(ShortUUIDKey, prefix="atpt"): ...
class TranscriptSegmentID(ShortUUIDKey, prefix="tseg"): ...
class WordTimingID(ShortUUIDKey, prefix="wtim"): ...
class EvaluationResultID(ShortUUIDKey, prefix="eval"): ...
class OverrideID(ShortUUIDKey, prefix="ovrd"): ...

# Flights (prompt experimentation)
class PromptTemplateID(ShortUUIDKey, prefix="ptpl"): ...
class FlightID(ShortUUIDKey, prefix="flit"): ...
class SurveySchemaID(ShortUUIDKey, prefix="ssch"): ...
class SurveyID(ShortUUIDKey, prefix="srvy"): ...
